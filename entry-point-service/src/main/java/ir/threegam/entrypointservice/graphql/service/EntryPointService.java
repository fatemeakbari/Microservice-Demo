...
public class EntryPointService {
    ...
    public User getUserById(int id){
            ...
            return webClientBuilder.
                    build().
                    get().
                    uri("http://user-service/users/"+id).retrieve().
    ...
    public List<User> getUsers(){
        ...
        UserList userList =  webClientBuilder.
                build().
                get().
                uri("http://user-service/users").retrieve().
    ...
    public List<Book> getBooks(){
        ...
        BookList bookList = webClientBuilder.
                build().
                get().
                uri("http://book-service/books").retrieve().
        ...
        webClientBuilder.
                build().
                get().
                uri("http://user-service/users/"+book.getUserId()).retrieve().
                bodyToMono(User.class).
                block()
        ));
